...
export default function CookieBanner() {
  ...
  <div className="max-w-3xl mx-auto">
    ...
    <p className="text-base text-gray-700 dark:text-gray-300 mb-4 leading-relaxed">
      This site uses essential third-party cookies to securely authenticate users and enable critical features
      of the service. <br className="hidden sm:inline" />We <strong className="font-semibold text-gray-900 dark:text-white">never</strong> use cookies for advertising or tracking purposes.
    </p>
    <button
