    ...
    <footer className="w-full border-t bg-background px-20">
      <div className="container flex flex-col items-center justify-between gap-4 py-10 md:h-24 md:flex-row md:py-0">
        ...
        <div className="flex items-center gap-4">
          <Link href="https://github.com/Saksham-Goel1107/Dionysus" target="_blank" className="hover:text-primary">
          ...
          <Link href="https://www.linkedin.com/in/saksham-goel-88b74b33a" target="_blank" className="hover:text-primary">
