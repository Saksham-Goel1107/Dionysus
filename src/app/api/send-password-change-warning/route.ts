...
import { sendPasswordSetWarningEmail, sendPasswordChangeWarningEmail, sendPasswordDeleteWarningEmail } from '@/lib/email';
...
export async function POST(req: Request) {
  try {
    ...
    return NextResponse.json({ success: false, error: 'Failed to send warning email.' }, { status: 500 });
  }
}
