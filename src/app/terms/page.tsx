          ...
          <TabsContent value="terms" className="space-y-6">
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              <CardWithGradient gradient="violet">
                ...
                <CardContent className="space-y-2">
                  <p>
                    By using Dionysus, you agree to these terms in full. If you
                    disagree with these terms or any part of these terms, you
              ...
              <CardWithGradient gradient="blue">
                ...
                <CardContent className="space-y-2">
                  <p>
                    ...
                    service, or indeed our whole service, at our discretion and
                    without notice.
                  </p>
                </CardContent>
              </CardWithGradient>
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <p>
                ...
                of Dionysus's services, including our website, AI features, and
                any other software or services offered by us in connection with
                any of the foregoing ("Services").
              </p>

              <h3>1.1 Accepting these Terms</h3>
              <p>
                By registering for an account or using any of our Services, you
                agree to be bound by these Terms. If you don't agree to these
              ...
              <p>
                ...
                continue to use the Services after we've let you know about
                changes to the Terms, you're indicating that you agree to the
                modified Terms.
              </p>
              ...
              <p>
                To use many of the Services, you must register for an account.
              ...
              <p>
                We are constantly updating and improving our Services. We may
                add, alter, or remove functionality from a Service at any time
                without prior notice. We may also limit, suspend, or discontinue
                a Service at our discretion. If we discontinue a Service, where
                appropriate, we'll give you reasonable advance notice and a
          ...
          <TabsContent value="license" className="space-y-6">
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              <CardWithGradient gradient="amber">
                ...
                <CardContent>
                  <p>
                    ...
                    Dionysus for your internal business purposes.
                  </p>
                </CardContent>
              </CardWithGradient>
              ...
              <CardWithGradient gradient="rose">
                ...
                <CardContent>
                  <p>
                    All rights, title, and interest in and to the Services are
                    and will remain the exclusive property of Dionysus.
                  </p>
                </CardContent>
              </CardWithGradient>
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <p>
                Subject to these Terms, Dionysus grants you a limited,
              ...
              <p>
                ...
                Dionysus's property or the property of our licensors. Neither
                these Terms nor your use of the Services convey or grant to you
                any rights:
              </p>
              <ul>
                <li>
                  in or related to the Services except for the limited license
                  granted above; or
                </li>
                <li>
                  to use or reference in any manner Dionysus's company names,
              ...
              <h3>3.2 Feedback</h3>
              <p>
                If you provide feedback to us, we may use and share such
                feedback without restriction or obligation to you, as long as we
                don't identify you as the source of the feedback without your
                permission.
              </p>
            </div>
          </TabsContent>
          ...
          <TabsContent value="restrictions" className="space-y-6">
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              <CardWithGradient gradient="rose">
                ...
                <CardContent>
                  <p>Activities that are strictly prohibited when using our services, including abuse, illegal activities, and unauthorized access.</p>
                </CardContent>
              </CardWithGradient>
              ...
              <CardWithGradient gradient="amber">
                ...
                <CardContent>
                  <p>Guidelines for acceptable use of our services, including API rate limits and resource consumption.</p>
                </CardContent>
              </CardWithGradient>
              ...
              <CardWithGradient gradient="blue">
                ...
                <CardContent>
                  <p>Standards for content shared through our platform, including intellectual property and privacy requirements.</p>
                </CardContent>
              </CardWithGradient>
            </div>
            ...
            <div className="prose max-w-none dark:prose-invert">
              ...
              <p>
                To maintain the quality and integrity of our services, the following restrictions apply to all users
                of Dionysus. Violation of these terms may result in account suspension or termination.
              </p>

              <h3>4.1 Prohibited Activities</h3>
              <p>You agree not to:</p>
              <ul>
                <li>Use the services for any illegal purposes or to promote illegal activities</li>
                <li>Attempt to gain unauthorized access to any portion of the services or any other systems</li>
              ...
              <p>
                Users must adhere to the following resource usage guidelines:
              </p>
              <ul>
              ...
              <p>
                All content shared through Dionysus must:
              </p>
              <ul>
          ...
          <TabsContent value="liability" className="space-y-6">
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              <CardWithGradient gradient="violet">
                ...
                <CardContent>
                  <p>Our liability is limited to the extent permitted by law, and we are not responsible for indirect damages.</p>
                </CardContent>
              </CardWithGradient>
              ...
              <CardWithGradient gradient="emerald">
                ...
                <CardContent>
                  <p>Services are provided "as is" without any warranties, either express or implied.</p>
                </CardContent>
              </CardWithGradient>
              ...
              <CardWithGradient gradient="blue">
                ...
                <CardContent>
                  <p>Users agree to indemnify and hold us harmless from claims arising from their use of the service.</p>
                </CardContent>
              </CardWithGradient>
            </div>
            ...
            <div className="prose max-w-none dark:prose-invert">
              ...
              <p>
                To the maximum extent permitted by law, Dionysus and its affiliates shall not be liable for:
              </p>
              <ul>
              ...
              <p>
                You agree to indemnify, defend, and hold harmless Dionysus and its officers, directors,
