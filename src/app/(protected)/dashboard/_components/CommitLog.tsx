      ...
      <ul className="space-y-6 overflow-x-hidden">
        {sortedCommits.map((commit, commitIdx) => (
          <li key={commit.id} className="relative flex items-start gap-x-4">
            ...
            >
              <div
                className={`w-px translate-x-1 ${resolvedTheme === 'dark' ? 'bg-gray-800' : 'bg-gray-200'}`}
              ></div>
            </div>
            ...
            <>
              ...
              <div
                className={`flex-auto rounded-md ${resolvedTheme === 'dark' ? 'bg-gray-900' : 'bg-white'} p-3 ring-1 ring-inset ${resolvedTheme === 'dark' ? 'ring-gray-700' : 'ring-gray-200'}`}
              >
                <div className="flex justify-between gap-x-4">
                  ...
                  >
                    <span
                      className={`text-${resolvedTheme === 'dark' ? 'gray-100' : 'gray-900'} font-semibold`}
                    >
                ...
                <span
                  className={`text-${resolvedTheme === 'dark' ? 'gray-300' : 'gray-800'} font-medium`}
                >
