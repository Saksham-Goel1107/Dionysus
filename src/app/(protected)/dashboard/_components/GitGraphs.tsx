          ...
          <div className="flex flex-col items-center justify-center space-y-6 py-10">
            <div className="flex flex-col items-center space-y-2">
              ...
              <p className="text-center text-lg text-gray-500 dark:text-gray-300 max-w-xl">
                Instantly visualize your repository’s structure with a beautiful, premium-quality diagram. 
                Perfect for documentation, onboarding, and sharing insights with your team.
              </p>
            </div>
            <Button
            disabled={true}
