      ...
      {!hasProPlan ? (
        ...
        <div className="mx-auto max-w-xl rounded-lg border bg-background p-8 shadow-md">
          ...
          <ol className="mb-6 list-decimal space-y-3 pl-5 text-base">
            <li>
              <span className="font-semibold">Click the button below</span> to launch your GitHub
              repository in CodeSandbox.
            </li>
            <li>
              <span className="font-semibold">Sign in to CodeSandbox</span> with your GitHub account
              if prompted.
            </li>
            <li className={` ${resolvedTheme === 'dark' ? 'text-gray-200' : 'text-gray-600'}`}>
              After Signin from the top right corner open the project in your gitaccount from the
              dropdown to properly commit changes to github
            </li>
            <li>
              ...
              <ul className="ml-5 mt-1 list-disc space-y-1 text-sm text-gray-600 dark:text-gray-300">
                <li>
                  You must grant CodeSandbox access to your private repo. Follow the on-screen
                  instructions after clicking the button.
                </li>
                <li>
                  If you see a 404 or permission error, check your GitHub integration settings in
                  CodeSandbox.
                </li>
              </ul>
            </li>
            <li>
              <span className="font-semibold">Make your changes</span> directly in
              CodeSandbox&apos;s online editor.
            </li>
            <li>
              <span className="font-semibold">Push changes back to GitHub:</span>
              <ul className="ml-5 mt-1 list-disc space-y-1 text-sm text-gray-600 dark:text-gray-300">
                <li>
                  Use the <span className="font-mono">Commit</span> and{' '}
                  <span className="font-mono">Push</span> options in CodeSandbox&apos;s UI.
                </li>
                <li>Ensure you&apos;re authenticated with GitHub to enable pushing.</li>
              </ul>
            </li>
          </ol>
          <a
