...
import { Loader2, CheckCircle, AlertTriangle, XCircle, ArrowLeft, Sparkles, CreditCard } from "lucide-react";
  ...
  const utils = api.useUtils();  useEffect(() => {
    const processPayment = async () => {
      ...
      try {
        ...
        try {
          const checkResponse = await fetch(`/api/stripe/check-payment-status?payment_intent_id=${sessionId}`);
        ...
        if (result.success) {
          ...
          toast({
            ...
            description: "There was an issue adding credits to your account. Please contact support if you were charged.",
            variant: "destructive",
          });
        }
      } catch (error: any) {
    ...
    processPayment();
  }, [searchParams, toast, utils.project.getMyCredits, utils.project.getMyTransactions]);  return (
    <Card className="w-full max-w-2xl shadow-lg">
      <CardHeader className="text-center border-b pb-6">
        <CardTitle className="text-2xl">Payment Status</CardTitle>
        <CardDescription>
          {isProcessing ? "Processing your transaction..." : 
           isSuccess ? `Successfully added ${creditsAmount} credits to your account` :
           isAlreadyProcessed ? "Transaction previously processed" : 
           noTransaction ? "No transaction details found" : "Transaction could not be processed"}
        </CardDescription>
      </CardHeader>
        ...
        {isProcessing ? (
          <div className="flex flex-col items-center py-8 gap-6">
            ...
            <div className="text-center space-y-2">
              ...
              <p className="text-muted-foreground max-w-md">
                Please don't close this page. We're confirming your payment and adding credits to your account.
              </p>
            </div>
          </div>
        ) : isAlreadyProcessed ? (
          <div className="flex flex-col items-center py-8 text-center gap-6">
            ...
            <div className="space-y-2 max-w-md">
              ...
              <p className="text-muted-foreground">
                This transaction was previously processed and credits were already added to your account.
                No additional credits have been added.
              </p>
            </div>
          ...
          <div className="flex flex-col items-center py-8 text-center gap-6">
            ...
            <div className="space-y-2 max-w-md">
              ...
              <p className="text-muted-foreground">
                Your payment was processed successfully and {creditsAmount} credits have been added to your account.
                You can now use these credits to create new projects.
              </p>
            </div>
            <div className="bg-green-50 text-green-900 rounded-lg p-4 flex items-center gap-3 text-sm">
          ...
          <div className="flex flex-col items-center py-8 text-center gap-6">
            ...
            <div className="space-y-2 max-w-md">
              ...
              <p className="text-muted-foreground">
                We encountered an issue while processing your payment. If you believe this is an error or 
                your card was charged, please contact our support team.
              </p>
            </div>
          </div>
        )}
...
export default function BillingSuccessPage() {
  return (
    <div className="container max-w-5xl mx-auto py-12 flex flex-col items-center">
      <div className="mb-12">
