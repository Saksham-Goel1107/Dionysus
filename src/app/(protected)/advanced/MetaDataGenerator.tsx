...
const metaDataFormSchema = z.object({
  // Basic
  title: z.string().min(5, { message: "Title must be at least 5 characters" }).max(60, { message: "Title should be less than 60 characters" }),
  description: z.string().min(50, { message: "Description must be at least 50 characters" }).max(160, { message: "Description should be less than 160 characters" }),
  ...
  ogImage: z.string().url({ message: "Please enter a valid image URL" }).optional().or(z.literal('')),
  ...
  twitterImage: z.string().url({ message: "Please enter a valid image URL" }).optional().or(z.literal('')),
    ...
    return (
      <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 mb-4">
        <div className="flex flex-col gap-2">
          ...
          <h3 className="font-bold text-blue-600 dark:text-blue-400 line-clamp-1">{title || 'Your Page Title'}</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400 line-clamp-2">
            {description || 'Your page description will appear here. Make sure it\'s compelling and informative.'}
          </p>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Title for social media (defaults to main title)" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Title for Twitter (defaults to OG title)" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Description for Twitter (defaults to OG description)" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
            ...
            <div className="space-y-4">
              ...
              <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-lg p-4">
                ...
                <p className="text-amber-700 dark:text-amber-300/80 text-sm">
                  Copy the generated meta tags and paste them into the <code className="bg-amber-100 dark:bg-amber-900/50 px-1 rounded">&lt;head&gt;</code> section of your HTML document. These tags help search engines and social media platforms understand and display your content correctly.
                </p>
              </div>
    ...
    <div className="w-full max-w-2xl mx-auto my-6 p-8 bg-gradient-to-br from-green-50 via-white to-green-100 dark:from-green-900/60 dark:via-green-950/80 dark:to-green-900/60 rounded-2xl border border-green-300 dark:border-green-700 shadow-xl flex flex-col items-center relative overflow-hidden">
      ...
      <h2 className="text-2xl font-extrabold mb-3 text-green-800 dark:text-green-100 drop-shadow-lg z-10 tracking-tight">
        <span className="inline-block align-middle mr-2">
          <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="inline-block text-green-500 dark:text-green-300">
      ...
      <p className="mb-6 text-green-700/80 dark:text-green-200/80 text-center max-w-lg z-10 text-sm md:text-base">
        Create perfect SEO meta tags for your website. Optimize for search engines and social media with custom titles, descriptions, and images.
      </p>
