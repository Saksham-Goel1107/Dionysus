          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-xl p-6 w-full max-w-2xl relative max-h-[98vh] overflow-y-auto mx-2">
            ...
            <div className="w-full text-blue-900 dark:text-blue-100 text-sm space-y-4">
              <div>
                ...
                <p className="mt-1">
                  Wiki generation is the process of creating comprehensive, well-structured documentation for your project directly on GitHub. This helps onboard new contributors, clarify project goals, and provide ongoing support for users and developers.
                </p>
              </div>
              <div>
                <b>Why Use GitHub Copilot for Wiki?</b>
                <ul className="list-disc pl-5 mt-1">
                  <li>Copilot leverages AI to suggest, summarize, and improve documentation content in real time.</li>
                  <li>It can help you write clear explanations, generate code samples, and maintain consistency across your wiki.</li>
                  <li>Copilot is especially useful for premium users who want to save time and ensure high-quality docs.</li>
                </ul>
              </div>
              <div>
                ...
                <ol className="list-decimal pl-5 mt-1 space-y-1">
                  <li>
                    ...
                    and subscribe if you haven't already. Else you can use it for free as everyone has 50 free requests per month.
                  </li>
                  <li>
                    Install the <b>GitHub Copilot</b> browser extension (if available) or use Copilot in your preferred code editor (VS Code, JetBrains, etc.).
                  </li>
                  <li>
                    Suggested to use claude models like claude sonnet 3.5 or 3.7 etc for best results.
                  </li>
                  <li>Sign in with your GitHub account and authorize Copilot access.</li>
                  <li>Navigate to your repository on GitHub and click the <b>Wiki</b> tab.</li>
                  <li>Click <b>New Page</b> to start a new wiki entry.</li>
                  <li>
                    In the editor, use Copilot suggestions or paste prompts to generate content. You can trigger Copilot by typing natural language instructions or using <b>Ctrl+Enter</b> (or <b>Cmd+Enter</b> on Mac) in supported editors.
                  </li>
                  <li>
                    Review, edit, and format the generated content for clarity and accuracy. Use markdown for structure (headings, lists, code blocks, etc.).
                  </li>
                  <li>Save your changes and organize pages with a clear, logical structure. Link related pages for easy navigation.</li>
                  <li>Repeat the process for all major sections: Overview, Setup, API, FAQ, Contributing, etc.</li>
                </ol>
              </div>
              <div>
                ...
                <div className="mt-3 text-xs text-blue-800 dark:text-blue-200">
                  <b>Tip:</b> For best results, use these prompts in order. Start with a codebase analysis, then generate overview, structure, and documentation for each section. Always instruct Copilot to reference the actual code, not just the README or generic templates.
                </div>
              </div>
              <div>
                <b>How to Get Copilot to Use Code Context Effectively:</b>
                <ul className="list-disc pl-5 mt-1">
                  <li>Open the relevant code files in your editor or GitHub web interface before prompting Copilot. This increases the chance Copilot will use the code context.</li>
                  <li>Be explicit in your prompt: say "based on the code in this file" or "analyze the codebase and...".</li>
                  <li>If Copilot generates generic or off-topic content, refine your prompt to mention specific files, functions, or code sections.</li>
                  <li>For large codebases, break down documentation generation by module or feature for more accurate results.</li>
                  <li>After each Copilot suggestion, review and edit for accuracy, and ask follow-up prompts for missing details.</li>
                </ul>
              </div>
              <div>
                <b>Pro Tips for Premium Users:</b>
                <ul className="list-disc pl-5 mt-1">
                  <li>Always review and edit Copilot's suggestions for accuracy and project-specific details.</li>
                  <li>Use markdown formatting for clarity: <code># Headings</code>, <code>```code blocks```</code>, <code>[links](url)</code>, etc.</li>
                  <li>Keep documentation up to date as your project evolves.</li>
                  <li>Encourage your team to use Copilot for consistent, high-quality documentation.</li>
                  <li>Organize your wiki with a clear table of contents and cross-links between pages.</li>
                  <li>For sensitive or private projects, ensure no confidential information is included in public wikis.</li>
                </ul>
              </div>
              <div className="mt-4 text-xs text-blue-700 dark:text-blue-200 bg-blue-100 dark:bg-blue-800/40 rounded p-2">
                <b>Note:</b> These steps are designed for premium users who want to maximize the value of GitHub Copilot for documentation. Even though Copilot is powerful, always use your expertise to ensure the highest quality and accuracy.
              </div>
            </div>
          </div>
        </div>
