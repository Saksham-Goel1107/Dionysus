              ...
              <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-lg p-4">
                ...
                {selectedTab === 'robot' ? (
                  <div className="text-amber-700 dark:text-amber-300/80 text-sm space-y-2">
                    <p>
                      Place the <code className="bg-amber-100 dark:bg-amber-900/50 px-1 rounded">robots.txt</code> file in the root directory public folder of your website.
                    </p>
                    <p>
                  ...
                  <div className="text-amber-700 dark:text-amber-300/80 text-sm space-y-2">
                    <p>
                      Place the <code className="bg-amber-100 dark:bg-amber-900/50 px-1 rounded">sitemap.xml</code> file in the root directory public folder of your website.
                    </p>
                    <p>
