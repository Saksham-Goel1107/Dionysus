							...
							<Button
								onClick={() => {
									...
									if (allSelected) {
										...
										CLAUSES.forEach((c) => { all[c.key] = true; });
										setClauses(all);
									}
								}}
								variant="outline"
