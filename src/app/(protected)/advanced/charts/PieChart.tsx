...
const COLORS = ["#0088FE", "#00C49F", "#FFBB28", "#FF8042", "#A28CF6", "#FF6699", "#FF4444", "#00B8D9"];
  ...
  return (
    <div className="w-full h-72">
      <ResponsiveContainer width="100%" height="100%">
        <PieChart>
          <Pie data={data} dataKey="functions" nameKey="name" cx="50%" cy="50%" outerRadius={60} fill="#8884d8" label>
