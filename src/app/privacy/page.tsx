      ...
      <Tabs defaultValue="privacy-policy" className="space-y-8">
        ...
        <TabsContent value="privacy-policy" className="space-y-6">
          <div className="prose dark:prose-invert max-w-none">
            <h2>Introduction</h2>
            <p>
              At Dionysus, we take your privacy seriously. This Privacy Policy
              explains how we collect, use, disclose, and safeguard your
              information when you use our AI-powered meeting assistant service.
            ...
            <h3>Meeting Data</h3>
            <p>
              When you use our services, we collect data from your meetings,
              including:
            </p>
            <ul>
            ...
            <p>
              We consider meeting content to be sensitive information and handle
              it with the utmost care. Meeting content is processed according to
              your instructions and used solely to provide you with the services
              you request.
            </p>
            ...
            <p>
              ...
              operation of our platform, and for our internal analytics and
              reporting purposes.
            </p>
            ...
            <ul>
              ...
              <li>
                Send administrative information to you, such as changes to our
            ...
            <h3>AI Processing</h3>
            <p>
              Dionysus uses artificial intelligence and machine learning
              technologies to power its core features. This includes:
            </p>
            <ul>
            ...
            <p>
              Your data is processed algorithmically to provide these services.
              We do not use your meeting content to train our general AI models
              without your explicit consent.
            </p>

            <h2>Data Retention</h2>
            <p>
              We will only keep your personal information and meeting data for
            ...
            <p>
              ...
              information for longer than the period of time in which you have
              an account with us. When you delete your account, we will delete
              or anonymize your information consistent with our data retention
              policies.
            </p>
            <p>
              Meeting recordings and transcripts are retained based on your
              subscription level:
            </p>
            <ul>
              ...
              <li>
                Enterprise tier: Up to 1 year, or as specified in your contract
              </li>
            </ul>
          </div>
        </TabsContent>
        ...
        <TabsContent value="data-processing" className="space-y-6">
          <div className="prose dark:prose-invert max-w-none">
            ...
            <p>
              This section provides detailed information about how we process
              your data, including the legal bases for processing, data
              transfers, and our security measures.
            </p>

            <h3>Legal Basis for Processing</h3>
            <p>
              We process your personal information for the purposes described in
              this Privacy Policy based on the following legal grounds:
            </p>
            <ul>
              <li>
                <strong>Performance of a Contract:</strong> Processing your
                information to fulfill our obligations under our Terms of
                Service or other agreements with you.
              </li>
              <li>
                <strong>Legitimate Interests:</strong> Processing your
                information for our legitimate business interests, such as
                improving our services and providing security.
              </li>
              <li>
                <strong>Consent:</strong> Processing your information with your
                explicit consent for specific purposes.
              </li>
              <li>
                <strong>Legal Obligations:</strong> Processing your information
            ...
            <p>
              Dionysus is a global service. Your information may be transferred
              to, and processed in, countries other than the country in which
              you are resident. These countries may have data protection laws
              that are different from the laws of your country.
            </p>
            <p>
              Specifically, our servers are located in the United States, and
              our third-party service providers and partners operate globally.
              This means that when we collect your information, we may process
              it in any of these countries.
            </p>
            <p>
              ...
              in accordance with applicable law. We take steps to ensure that
              adequate safeguards are in place to protect your information when
              it is transferred internationally, including:
            </p>
            <ul>
              <li>Using EU-approved Standard Contractual Clauses</li>
              <li>
                Ensuring our partners have certified under the EU-U.S. and
            ...
            <ul>
              ...
              <li>
                Monitoring systems for detecting and addressing security
                incidents
              </li>
            ...
            <p>
              ...
              to assist us in providing you with our services. These third
            ...
            <Table>
              ...
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell>
                    Billing information, transaction history
                  </TableCell>
                </TableRow>
                <TableRow>
            ...
            <p>
              We ensure that all third-party service providers agree to strict
              data protection terms that are consistent with this Privacy
              Policy.
            </p>
          </div>
        </TabsContent>
        ...
        <TabsContent value="cookies" className="space-y-6">
          <div className="prose dark:prose-invert max-w-none">
            ...
            <p>
              ...
              use information about you. Cookies are small data files stored on
            ...
            <Table>
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell>
                    Necessary for the website to function properly. These enable
                ...
                <TableRow>
                  ...
                  <TableCell>
                    Used to deliver relevant advertisements based on your
                    interests and track the effectiveness of marketing
                    campaigns.
                  </TableCell>
                  <TableCell>Persistent (up to 1 year)</TableCell>
                </TableRow>
            ...
            <p>
              ...
              settings preferences. To find out more about cookies, including
              how to see what cookies have been set, visit{" "}
              <a
            ...
            <p>
              ...
              Here's how to remove cookies from popular browsers:
            </p>
            ...
            <ul>
              ...
              <li>
                <strong>Edge:</strong> Settings → Site permissions → Cookies and
                site data
              </li>
            </ul>
            ...
            <h3>Do Not Track</h3>
            <p>
              We respect your choice if you enable the "Do Not Track" setting in
              your browser. When DNT is enabled, we do not use analytics or
              advertising cookies.
            </p>
            ...
            <p>
              ...
              other tracking technologies to improve your browsing experience,
              analyze website traffic, and gather demographic information about
              our user base as a whole.
            </p>
            <p>
              These technologies help us understand how users engage with our
              website and allow us to analyze the effectiveness of our marketing
              campaigns.
            </p>

            <h3>Third-Party Analytics</h3>
            <p>
              We use third-party analytics services to help understand user
              behavior on our website. These services may collect information
              about your use of our website, which is transmitted to the service
              provider. We use this information to improve our website and
              services.
            </p>
        ...
        <TabsContent value="rights" className="space-y-6">
          <div className="prose dark:prose-invert max-w-none">
            ...
            <p>
              ...
              certain rights regarding your personal information. These may
              include:
            </p>
            ...
            <ul>
              ...
              <li>
                <strong>Object:</strong> You can object to our processing of
                your personal information.
              </li>
              <li>
                <strong>Data Portability:</strong> You can ask that we transfer
                your personal information to another organization.
              </li>
            </ul>
            ...
            <p>
              ...
              General Data Protection Regulation (GDPR) and UK GDPR. If you are
              a California resident, you have rights under the California
            ...
            <ul>
              <li>
                Withdraw consent at any time if we are processing your
            ...
            <p>
              ...
              have not sold any personal information in the preceding 12 months.
            </p>
            ...
            <p>
              ...
              <a href="https://dionysusai.com/privacy-request">
                Privacy Request Form
              </a>
              <br />
              <strong>Mail:</strong> Dionysus Privacy Team, 123 AI Street, San
            ...
            <p>
              ...
              on this page. If we make material changes to this policy, we will
              notify you through a notice on our website or by email.
            </p>
            ...
            <p>
              For data subjects in the EU, our EU representative can be
              contacted at:
